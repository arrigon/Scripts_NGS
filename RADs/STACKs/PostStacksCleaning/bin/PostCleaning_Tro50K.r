...
ncores = 10
tsv = "../data.in/Tro50Km3complete.SNP"
cov = "../data.in/Tro50Km3complete.COV"
workfolder = "../savedanalyses"
outfolder = "../data.out"
bestscorers = 0.2 #parameter to pick-up best specimens. these are defined as having more than bestscorers * mean(NrStacks / specimen)
minTaxDepth = 0.3 #parameter to pick-up loci, minimum proportion of taxa in which locus is observed
maxAlleles = 3
maxlenSNP = 5
...
boxplot(apply(MCOV[target,], 1, sd, na.rm=T), 
	apply(MCOV[target,], 2, sd, na.rm=T), 
	ylab = "SD Coverage",
