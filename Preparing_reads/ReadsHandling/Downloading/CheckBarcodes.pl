...
# Input: $infile
#
# Usage: perl CheckBarcodes.pl infile
#
...
my $lenbcde = 6;
my $lenrstr = 6;
my $rstr = "TGCAGG"; #expected restriction site (MseI = TGCAGG, EcoRI = AATTC)
...
my $command = "grep -c $rstr CheckBarcodes/$bsn > $bsn.restr.instances ";
system($command);
