...
# my $motif = "Sbf1";
my $command = "perl bin/FinalClean.pl $workfolder/tmp/merged $workfolder/stacks $motif $bclength $MaxLen $keepbc";
print("\nRunning: $command\n\n");
system($command);
...
system("cat $workfolder/stacks/* > $workfolder/logs/allfiles.fastq");
