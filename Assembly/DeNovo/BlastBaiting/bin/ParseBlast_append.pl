...
# Usage:
# perl ParseBlast_append.pl blastfile contigfile outfile append[hard coded]
#
# blastfile = blast hits (-outfmt 6, as obtained with Nucleotide-Nucleotide BLAST 2.2.25+)
